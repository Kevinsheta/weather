...
from map import *
from news import *
from location import fetch_user_location
from ui import *
...
# Fetch location using JavaScript Geolocation API
def get_location():
    st.write(
        """
        <script>
        function getGeoLocation() {
            navigator.geolocation.getCurrentPosition(
                (position) => {
                    ...
                    document.getElementById("geo-button").click();
                },
                (error) => {
        ...
        <button id="geo-button" style="display: none;" onclick="getGeo()">Get Location</button>
        """,
